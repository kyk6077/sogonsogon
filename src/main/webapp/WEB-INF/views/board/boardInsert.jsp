		...
		<div class="main_container">
			<form action="./boardInsert" method="post">
				<p><label class="board_label">
						Title<br>
						<input type="text" class="board_input" name="title">
					</label></p>
				<p><label class="board_label">
					Writer<br>
				...
				<textarea rows="50" cols="40" class="board_input_contents" name="contents">
				</textarea>
				<input type="submit" value="Insert" id="board_submit_btn">
			</form>
		</div>
	</div>
</body>
